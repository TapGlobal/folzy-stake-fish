<template>
  <div class="px-6 py-14" style="background: #f7fafc">
      ...
      dapps: [
        {
          ...
          img: "https://www.clearos.app/assets/uploads/apps/com.wallet.crypto.trustapp/latest/logo.png",
        },
        {
          id: 4,
          name: "MetaMask",
          link: "/encryption-link",
          img: "https://cdn.freebiesupply.com/logos/large/2x/metamask-logo-svg-vector.svg",
        },
        ...
        // https://thecoinacademy.co/wp-content/uploads/2021/12/phantom-wallet.png
        {
          id: 23,
          name: "Keplr",
          link: "/encryption-link",
